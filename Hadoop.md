Hadoop is an opensource software for reliable, scaleable, distributed computing. This works on distributed computing. Hadoop follows the leader-worker architecture.

Hadoop is designed with the fundamental assumptions of
- Hardware failures are common
- And such failures should be handled by the framework
