...
- In statistics, we learn about the characteristics of the population by taking samples
...
- The models are created on the the sample data. Final predication is outputted, after considering all the values of the minor models - predictions are averaged (for regression) or voted (for classification)
